(() => {
    ...
    function initSliders() {
        if (document.querySelector(".promo__slider")) new Swiper(".promo__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".promo__navigation .swiper-button-prev",
                nextEl: ".promo__navigation .swiper-button-next"
            },
            on: {}
        });
    ...
    checker();
    if (document.querySelectorAll(".options__input")) {
        const paymentButtons = document.querySelectorAll(".options__input");
        paymentButtons.forEach((item => {
            item.addEventListener("change", (function() {
                this.closest(".options__item").classList.toggle("active-payment");
                paymentButtons.forEach((otherItem => {
                    if (otherItem !== this) otherItem.closest(".options__item").classList.remove("active-payment");
                }));
            }));
        }));
    }
